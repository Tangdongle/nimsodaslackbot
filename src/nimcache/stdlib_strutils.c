...
/* Command for C compiler:
   gcc -c  -w  -I/home/ryan/.choosenim/toolchains/nim-0.18.0/lib -o /home/ryan/dev/slackbot/src/nimcache/stdlib_strutils.o /home/ryan/dev/slackbot/src/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_23, "invalid enum value: ", 20);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_27, "\012", 1);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_28, "invalid format string", 21);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_29, "invalid float: ", 15);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_30, "\0120 < len(sep) ", 14);
...
appendString(T9_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_23));
appendString(T9_, s);
...
N_LIB_PRIVATE N_NIMCALL(NIM_CHAR, nsuToUpperAsciiChar)(NIM_CHAR c) {
	...
	nimln_(230, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_25 = subInt(((NU8)(c)), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_25), ((NI) 0), ((NI) 255)))));
	}
	goto LA1_;
	LA3_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuToUpperAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		nimln_(243, "strutils.nim");
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_24 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_24);
		nimln_(2045, "system.nim");
		res = ((NI) 0);
		{
			nimln_(2046, "system.nim");
			while (1) {
				...
				nimln_(2048, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_26 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_26);
			} LA3: ;
		}
	}
	popFrame();
...
appendString(result, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_27));
				}
				LA8_: ;
				{
					NI j;
...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString_61EJWW6vRISEo9a8gt0tusw)(void) {
	...
	(*e).Sup.Sup.m_type = (&NTI_Gi06FkNeykJn7mrqRZYrkA_);
	T1_ = (NimStringDesc*)0;
	T1_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_28));
...
appendString(T7_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_29));
appendString(T7_, s);
		asgnRefNoCycle((void**) (&(*e).Sup.message), T7_);
		asgnRef((void**) (&(*e).Sup.parent), NIM_NIL);
		raiseException((Exception*)e, "ValueError");
...
N_LIB_PRIVATE N_NIMCALL(NI, nsuParseHexInt)(NimStringDesc* s) {
	NI result;
	NI i;
	nimfr_("parseHexInt", "strutils.nim");
	result = (NI)0;
	i = ((NI) 0);
	{
		NIM_BOOL T3_;
...
appendString(T20_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_13));
appendString(T20_, s);
...
N_LIB_PRIVATE N_NIMCALL(tySequence_sM4lkSb7zS6F7OVMvW9cffQ*, nsuSplitString)(NimStringDesc* s, NimStringDesc* sep, NI maxsplit) {
	...
	result = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*)0;
	{
		...
		raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_30));
	}
	LA3_: ;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, nsuIsNilOrEmpty)(NimStringDesc* s) {
	NIM_BOOL result;
	nimfr_("isNilOrEmpty", "strutils.nim");
	result = (NIM_BOOL)0;
	result = ((s ? s->Sup.len : 0) == ((NI) 0));
	popFrame();
	return result;
}
