...
/* Command for C compiler:
   gcc -c  -w  -I/home/ryan/.choosenim/toolchains/nim-0.18.0/lib -o /home/ryan/dev/slackbot/src/nimcache/stdlib_uri.o /home/ryan/dev/slackbot/src/nimcache/stdlib_uri.c */
...
static N_INLINE(NI, parseWhile_qdvLFftz9bNgVOsqVGmFlKQuri)(NimStringDesc* s, NimStringDesc** token, tySet_tyChar_nmiMWKVIe46vacnhAFrQvw validChars, NI start);
...
N_LIB_PRIVATE N_NIMCALL(tySequence_sM4lkSb7zS6F7OVMvW9cffQ*, X5BX5D__tX2kzp5TuaXA7hsA0cL89bA)(tyObject_Table_LLQadDAXEvd71UDdEc3lDA query, NimStringDesc* key);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, X5BX5D__h7FfzQTvewii8Cmc7PnkfQ)(tyObject_Table_LLQadDAXEvd71UDdEc3lDA query, NimStringDesc* key, NI i);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, toString_k0GQHkqd1dUP9cCBSTVcdKg)(tySequence_sM4lkSb7zS6F7OVMvW9cffQ* value);
N_LIB_PRIVATE N_NIMCALL(void, parseQuery_9apkirFWg3tkYtnKOCudfDA)(NimStringDesc* query, tyObject_Table_LLQadDAXEvd71UDdEc3lDA* Result);
...
extern TNimType NTI_LLQadDAXEvd71UDdEc3lDA_;
...
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_VzbRQH9cb1xm1tSKH4PwBSw_68 = {
0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM_VzbRQH9cb1xm1tSKH4PwBSw_69, "query[i] == \'=\' ", 16);
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_VzbRQH9cb1xm1tSKH4PwBSw_71 = {
...
{	nimln_(153, "uri.nim");
	...
	nimln_(166, "uri.nim");
	T11_ = (NI)0;
	T11_ = parseWhile_qdvLFftz9bNgVOsqVGmFlKQuri(uri, (&(*result).scheme), TM_VzbRQH9cb1xm1tSKH4PwBSw_35, i);
...
N_LIB_PRIVATE N_NIMCALL(void, parseUri_RvyL7IMLrYm3DvIkorH8qQ)(NimStringDesc* uri, tyObject_Uri_j49bukNPrq747O1GRd4Ng9bQ* Result) {
	...
	nimln_(192, "uri.nim");
	parseUri_ptsKXQBj1pWLnjru04i7vA(uri, Result);
	popFrame();
}
...
{	result = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*)0;
	nimln_(376, "uri.nim");
	result = X5BX5D__YD5KOfs9aChBcjwvm79bWxhA(query, key);
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
{	result = (NimStringDesc*)0;
	...
	T1_ = X5BX5D__YD5KOfs9aChBcjwvm79bWxhA(query, key);
	if ((NU)(((NI) 0)) >= (NU)(T1_->Sup.len)) raiseIndexError();
	result = copyString(T1_->data[((NI) 0)]);
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, toString_k0GQHkqd1dUP9cCBSTVcdKg)(tySequence_sM4lkSb7zS6F7OVMvW9cffQ* value) {
	NimStringDesc* result;
	nimfr_("toString", "uri.nim");
{	result = (NimStringDesc*)0;
	nimln_(382, "uri.nim");
	if ((NU)(((NI) 0)) >= (NU)(value->Sup.len)) raiseIndexError();
	result = copyString(value->data[((NI) 0)]);
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, parseQuery_9apkirFWg3tkYtnKOCudfDA)(NimStringDesc* query, tyObject_Table_LLQadDAXEvd71UDdEc3lDA* Result) {
	tyObject_Table_LLQadDAXEvd71UDdEc3lDA res;
	NI i;
	nimfr_("parseQuery", "uri.nim");
{	chckNil((void*)Result);
	genericReset((void*)Result, (&NTI_LLQadDAXEvd71UDdEc3lDA_));
	memset((void*)(&res), 0, sizeof(res));
	nimln_(385, "uri.nim");
	initTable_11SA0A9aqibwRCaMRv3dYJg(((NI) 64), (&res));
	nimln_(386, "uri.nim");
	i = ((NI) 0);
	{
		nimln_(388, "uri.nim");
		while (1) {
			NimStringDesc* key;
			NimStringDesc* value;
			NI TM_VzbRQH9cb1xm1tSKH4PwBSw_70;
			nimln_(398, "system.nim");
			nimln_(388, "uri.nim");
			if ((NU)(i) > (NU)(query->Sup.len)) raiseIndexError();
			if (!!(((NU8)(query->data[i]) == (NU8)(0)))) goto LA2;
			nimln_(389, "uri.nim");
			key = copyString(((NimStringDesc*) &TM_VzbRQH9cb1xm1tSKH4PwBSw_31));
			nimln_(390, "uri.nim");
			value = copyString(((NimStringDesc*) &TM_VzbRQH9cb1xm1tSKH4PwBSw_31));
			nimln_(391, "uri.nim");
			i = parseUntil_zSglkPmqQkVaLkVSiDuiCguri(query, (&key), TM_VzbRQH9cb1xm1tSKH4PwBSw_68, i);
			nimln_(392, "uri.nim");
			{
				if ((NU)(i) > (NU)(query->Sup.len)) raiseIndexError();
				if (!!(((NU8)(query->data[i]) == (NU8)(61)))) goto LA5_;
				failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_VzbRQH9cb1xm1tSKH4PwBSw_69));
			}
			LA5_: ;
			nimln_(393, "uri.nim");
			TM_VzbRQH9cb1xm1tSKH4PwBSw_70 = addInt(i, ((NI) 1));
			i = (NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_70);
			nimln_(395, "uri.nim");
			i = parseUntil_zSglkPmqQkVaLkVSiDuiCguri(query, (&value), TM_VzbRQH9cb1xm1tSKH4PwBSw_71, i);
			nimln_(396, "uri.nim");
			{
				NI TM_VzbRQH9cb1xm1tSKH4PwBSw_72;
				if ((NU)(i) > (NU)(query->Sup.len)) raiseIndexError();
				if (!((NU8)(query->data[i]) == (NU8)(38))) goto LA9_;
				TM_VzbRQH9cb1xm1tSKH4PwBSw_72 = addInt(i, ((NI) 1));
				i = (NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_72);
			}
			LA9_: ;
			nimln_(398, "uri.nim");
			{
				...
				NimStringDesc* T18_;
				T13_ = (NIM_BOOL)0;
				T13_ = contains_pcmEVCyAwAm4n6uMb9bd7mQ(res, key);
				if (!T13_) goto LA14_;
				nimln_(399, "uri.nim");
				T16_ = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ**)0;
				T16_ = X5BX5D__IuN3JD9aQgZX7ND9cYyXSo8g((&res), key);
				(*T16_) = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV2(&((*T16_))->Sup, sizeof(NimStringDesc*));
				T17_ = (*T16_)->Sup.len++;
				T18_ = (NimStringDesc*)0;
				T18_ = (*T16_)->data[T17_]; (*T16_)->data[T17_] = copyStringRC1(value);
				if (T18_) nimGCunrefNoCycle(T18_);
			}
			goto LA11_;
			LA14_: ;
			{
				tySequence_sM4lkSb7zS6F7OVMvW9cffQ* T20_;
				NimStringDesc* T21_;
				nimln_(401, "uri.nim");
				T20_ = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*)0;
				T20_ = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) newSeq((&NTI_sM4lkSb7zS6F7OVMvW9cffQ_), 1);
				T21_ = (NimStringDesc*)0;
				T21_ = T20_->data[0]; T20_->data[0] = copyStringRC1(value);
				if (T21_) nimGCunrefNoCycle(T21_);
				X5BX5Deq__un8Mk4BNkyXrzCk9aVyJLyg((&res), key, T20_);
			}
			LA11_: ;
		} LA2: ;
	}
	nimln_(403, "uri.nim");
	genericSeqAssign((&(*Result).data), res.data, (&NTI_JiteSJxrvz63iP2o9bcn2Sg_));
	(*Result).counter = res.counter;
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
}
...
static N_INLINE(NI, nextTry_OLPhxSyW9bte5CwHzzQVhfAtables)(NI h, NI maxHash) {
	NI result;
	NI TM_VzbRQH9cb1xm1tSKH4PwBSw_73;
	nimfr_("nextTry", "tableimpl.nim");
	result = (NI)0;
	nimln_(28, "tableimpl.nim");
	TM_VzbRQH9cb1xm1tSKH4PwBSw_73 = addInt(h, ((NI) 1));
	result = (NI)((NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_73) & maxHash);
	popFrame();
	return result;
}
...
static N_INLINE(NI, rawGet_IKEP9cnFCFaJ7ddTfNBNwiAtables)(tyObject_Table_LLQadDAXEvd71UDdEc3lDA t, NimStringDesc* key, NI* hc) {
	...
	NI h;
	NI T5_;
	NI TM_VzbRQH9cb1xm1tSKH4PwBSw_74;
...
{	result = (NI)0;
	...
	TM_VzbRQH9cb1xm1tSKH4PwBSw_74 = subInt(((NI) -1), h);
	result = (NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_74);
	}BeforeRet_: ;
	popFrame();
	return result;
}
...
static N_INLINE(NI, rawGetKnownHC_RKwyKXZlTvFd0VZfVx9bcgQtables)(tyObject_Table_LLQadDAXEvd71UDdEc3lDA t, NimStringDesc* key, NI hc) {
	...
	NI h;
	NI T1_;
	NI TM_VzbRQH9cb1xm1tSKH4PwBSw_75;
...
{	result = (NI)0;
	...
	nimln_(40, "tableimpl.nim");
	TM_VzbRQH9cb1xm1tSKH4PwBSw_75 = subInt(((NI) -1), h);
	result = (NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_75);
	}BeforeRet_: ;
	popFrame();
	return result;
}
