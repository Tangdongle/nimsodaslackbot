...
/* Command for C compiler:
   gcc -c  -w  -I/home/ryan/.choosenim/toolchains/nim-0.18.0/lib -o /home/ryan/dev/slackbot/src/nimcache/stdlib_parseutils.o /home/ryan/dev/slackbot/src/nimcache/stdlib_parseutils.c */
...
static N_INLINE(NIM_CHAR, toLower_gKPHIHXd4J0BNtguLE8NFAparseutils)(NIM_CHAR c) {
	...
	result = (NIM_CHAR)0;
	nimln_(28, "parseutils.nim");
	{
		NI TM_vI9aZNKIcImom6dDyKXW1ZA_12;
		NI TM_vI9aZNKIcImom6dDyKXW1ZA_13;
		if (!(((NU8)(c)) >= ((NU8)(65)) && ((NU8)(c)) <= ((NU8)(90)))) goto LA3_;
		TM_vI9aZNKIcImom6dDyKXW1ZA_12 = subInt(((NU8)(c)), ((NI) 65));
		TM_vI9aZNKIcImom6dDyKXW1ZA_13 = addInt((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_12), ((NI) 97));
...
N_LIB_PRIVATE N_NIMCALL(NI, parseSaturatedNatural_heAOnV8CAiOgwhPKbfpRgA)(NimStringDesc* s, NI* b, NI start) {
	...
	nimln_(286, "parseutils.nim");
	{
		...
		if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
		if (!((NU8)(s->data[i]) == (NU8)(43))) goto LA3_;
		TM_vI9aZNKIcImom6dDyKXW1ZA_16 = addInt(i, ((NI) 1));
		i = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_16);
	}
	LA3_: ;
	nimln_(287, "parseutils.nim");
	{
		...
		(*b) = ((NI) 0);
		{
			...
			while (1) {
				...
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TM_vI9aZNKIcImom6dDyKXW1ZA_17 = subInt(((NU8)(s->data[i])), ((NI) 48));
				c = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_17);
				nimln_(291, "parseutils.nim");
				{
					...
					TM_vI9aZNKIcImom6dDyKXW1ZA_18 = subInt(((NI) IL64(9223372036854775807)), c);
					TM_vI9aZNKIcImom6dDyKXW1ZA_19 = divInt((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_18), ((NI) 10));
					if (!((*b) <= (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_19))) goto LA13_;
					nimln_(292, "parseutils.nim");
					TM_vI9aZNKIcImom6dDyKXW1ZA_20 = mulInt((*b), ((NI) 10));
					TM_vI9aZNKIcImom6dDyKXW1ZA_21 = addInt((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_20), c);
					(*b) = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_21);
				}
				goto LA11_;
				LA13_: ;
				{
		...
		nimln_(297, "parseutils.nim");
		TM_vI9aZNKIcImom6dDyKXW1ZA_24 = subInt(i, start);
		result = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_24);
	}
	LA7_: ;
	popFrame();
	return result;
