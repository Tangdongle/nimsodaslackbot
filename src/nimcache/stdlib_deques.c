...
/* Command for C compiler:
   gcc -c  -w  -I/home/ryan/.choosenim/toolchains/nim-0.18.0/lib -o /home/ryan/dev/slackbot/src/nimcache/stdlib_deques.o /home/ryan/dev/slackbot/src/nimcache/stdlib_deques.c */
...
STRING_LITERAL(TM_NdgYN5HU2ty0qMI5oazWyg_3, "isPowerOfTwo(initialSize) ", 26);
static N_NIMCALL(void, Marker_tySequence_WF89a8QyKeDCh4DYWTmSiBg)(void* p, NI op) {
...
N_LIB_PRIVATE N_NIMCALL(void, initDeque_ReEIfP39bwVCXJ79bSWPO49aw)(NI initialSize, tyObject_Deque_lXZKLUMbpAcAUzeVrG09bNg* Result) {
	NI TM_NdgYN5HU2ty0qMI5oazWyg_4;
	...
	nimln_(58, "deques.nim");
	{
		...
		if (!!(T3_)) goto LA4_;
		failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_NdgYN5HU2ty0qMI5oazWyg_3));
	}
	LA4_: ;
	nimln_(59, "deques.nim");
	TM_NdgYN5HU2ty0qMI5oazWyg_4 = subInt(initialSize, ((NI) 1));
	(*Result).mask = (NI)(TM_NdgYN5HU2ty0qMI5oazWyg_4);
...
N_LIB_PRIVATE N_NIMCALL(void, initDeque_9bAxh9aiIW8x9cABzXt8aTZyA)(NI initialSize, tyObject_Deque_104cP4q8EyDjHrsh1Phrmw* Result) {
	...
	nimfr_("initDeque", "deques.nim");
	chckNil((void*)Result);
	genericReset((void*)Result, (&NTI_104cP4q8EyDjHrsh1Phrmw_));
	nimln_(58, "deques.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
