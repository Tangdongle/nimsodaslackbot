...
/* Command for C compiler:
   gcc -c  -w  -I/home/ryan/.choosenim/toolchains/nim-0.18.0/lib -o /home/ryan/dev/slackbot/src/nimcache/stdlib_db_sqlite.o /home/ryan/dev/slackbot/src/nimcache/stdlib_db_sqlite.c */
...
extern tyProc_MGvm2GDOLe9cOGVrF2xiL8g Dl_457515_;
extern TNimType NTI_HDK9arR7eW5QkLI9bRSdsGnA_;
extern TNimType NTI_w65gHFDlremRAyGJ4f6zkA_;
extern tyProc_9c803Jlmvw39cDHXPnE9c9acPA Dl_457528_;
extern TFrame* framePtr_HRfVMH3jYeBJz6Q6X9b6Ptw;
extern tyObject_GcHeap_1TRH1TZMaVZTnLNcIHuNFQ gch_IcYaEuuWivYAS86vFMTS3Q;
extern tyProc_EhxAId0fqbb7y09bLz1RLng Dl_457543_;
extern tyProc_Fhopq8qsQV4lYKX3MLNyKQ Dl_457659_;
extern tyProc_Fhopq8qsQV4lYKX3MLNyKQ Dl_457701_;
extern tyProc_gjdebP9bh9a6kXA5fmIpsLzQ Dl_457409_;
extern TNimType NTI_sM4lkSb7zS6F7OVMvW9cffQ_;
extern tyProc_KJS9c3LPhRMY74OUoHq9bNBw Dl_457669_;
extern tyProc_mmgU9bW4w7JmLmc3EGsbdlg Dl_457689_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Sqlite3_xRZkbCqVWSKf8kX4o9cbKXA*, open_SRJkmN7JR2aulOhbafCrYA)(NimStringDesc* connection, NimStringDesc* user, NimStringDesc* password, NimStringDesc* database) {
	...
	nimln_(305, "db_sqlite.nim");
	{
		NI32 T3_;
		T3_ = (NI32)0;
		T3_ = Dl_457515_(connection->data, &db);
		if (!(T3_ == ((NI32) 0))) goto LA4_;
		nimln_(306, "db_sqlite.nim");
		result = db;
	}
	goto LA1_;
	LA4_: ;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryExec_Wy7WfNcrDtpQlAr7l6ZBZw)(tyObject_Sqlite3_xRZkbCqVWSKf8kX4o9cbKXA* db, NimStringDesc* query, NimStringDesc** args, NI argsLen_0) {
	...
	nimln_(131, "db_sqlite.nim");
	{
		...
		NI32 x;
		T3_ = (int)0;
		T3_ = Dl_457543_(db, q->data, ((int)chckRange((q ? q->Sup.len : 0), ((int) (-2147483647 -1)), ((int) 2147483647))), &stmt, NIM_NIL);
		if (!(T3_ == ((NI32) 0))) goto LA4_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Tstmt_KEhcjAECDwKIYLLjIzakvw*, setupQuery_6EQAJlzQgp6Lnc8upW20sQ)(tyObject_Sqlite3_xRZkbCqVWSKf8kX4o9cbKXA* db, NimStringDesc* query, NimStringDesc** args, NI argsLen_0) {
	...
	nimln_(148, "db_sqlite.nim");
	{
		...
		nimln_(148, "db_sqlite.nim");
		T3_ = (int)0;
		T3_ = Dl_457543_(db, q->data, ((int)chckRange((q ? q->Sup.len : 0), ((int) (-2147483647 -1)), ((int) 2147483647))), &result, NIM_NIL);
		if (!!((T3_ == ((NI32) 0)))) goto LA4_;
		dbError_yRzNipQFOsKqLVySy7Je9bw(db);
	}
	LA4_: ;
...
N_LIB_PRIVATE N_NIMCALL(tySequence_sM4lkSb7zS6F7OVMvW9cffQ*, newRow_yziwAL431pdzkjLvusuw3Q)(NI L) {
	...
	result = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) newSeq((&NTI_sM4lkSb7zS6F7OVMvW9cffQ_), ((NI)chckRange(L, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_Y7t52g9b69cVuzHT832OjgmA_10 = subInt(L, ((NI) 1));
		colontmp_ = (NI)(TM_Y7t52g9b69cVuzHT832OjgmA_10);
		...
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln_(143, "db_sqlite.nim");
				T4_ = (NimStringDesc*)0;
				T4_ = result->data[i]; result->data[i] = copyStringRC1(((NimStringDesc*) &TM_Y7t52g9b69cVuzHT832OjgmA_2));
				if (T4_) nimGCunrefNoCycle(T4_);
				nimln_(2048, "system.nim");
				TM_Y7t52g9b69cVuzHT832OjgmA_11 = addInt(res, ((NI) 1));
				res = (NI)(TM_Y7t52g9b69cVuzHT832OjgmA_11);
			} LA3: ;
		}
	}
	popFrame();
...
N_LIB_PRIVATE N_NIMCALL(void, setRow_i9caC20eiZfH0Cu9czRpxoPQ)(tyObject_Tstmt_KEhcjAECDwKIYLLjIzakvw* stmt, tySequence_sM4lkSb7zS6F7OVMvW9cffQ** r, int cols) {
	nimfr_("setRow", "db_sqlite.nim");
	{
		...
		col = (NI32)0;
		colontmp_ = (NI32)0;
		nimln_(151, "db_sqlite.nim");
		TM_Y7t52g9b69cVuzHT832OjgmA_12 = subInt(cols, ((NI32) 1));
		if (TM_Y7t52g9b69cVuzHT832OjgmA_12 < (-2147483647 -1) || TM_Y7t52g9b69cVuzHT832OjgmA_12 > 2147483647) raiseOverflow();
		colontmp_ = (NI32)(TM_Y7t52g9b69cVuzHT832OjgmA_12);
		...
		res = ((NI32) 0);
		{
			...
			while (1) {
				...
				col = res;
				nimln_(152, "db_sqlite.nim");
				if ((NU)(col) >= (NU)((*r)->Sup.len)) raiseIndexError();
				T4_ = (NI32)0;
				T4_ = Dl_457669_(stmt, col);
